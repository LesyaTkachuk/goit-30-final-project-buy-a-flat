                ...
                <form onSubmit={this.handleSubmit} className={styles.loginRegist__form}>
                    ...
                    <label className={styles.loginRegist__inputform}>
                        ...
                        <input
                            ...
                            autoFocus
                        />
                    <div className={styles.loginRegist__invalid}>{this.state.nameErorr}</div>
                    </label>
                    ...
                    <br/>
                    <button type="submit" className={styles.loginRegist__Bth}><p className={styles.loginRegist__Bth_text}>Зарегистрироваться</p></button>
